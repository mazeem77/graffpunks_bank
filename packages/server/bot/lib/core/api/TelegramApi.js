...
const InputMediaPhoto = require('../models/InputMediaPhoto');
...
class TelegramApi {
   ...
   */
  constructor(token, logger, payments) {
    this._token = token;
  ...
  _callWithReturnType(method, params, type, multipart) {
    return this.call(method, params, multipart).then(response => {
    ...
    req.post(
      ...
      (body, response, err) => {
        ...
        if (body && body.error_code) {
          ...
          if (error.code == 500) {
            this._logger.warn({
              'Got Internal server error from Telegram. Body:': body
            });
            this._retryRequest(request, resolve, reject);
          ...
          if (error.code === 429 && request.params && request.params.chat_id) {
            return this.sendMessage(
              request.params.chat_id,
              `🚧\n\nThere are too many requests were made within one minute. Please, retry after ${body.parameters.retry_after} seconds.\n\nПревышен лимит на получение сообщений! К сожалению, Telegram ограничивает количество сообщений, которые бот может отправить пользователю в течении минуты. Пожалуйста, попробуй снова через ${body.parameters.retry_after} секунд.`
            );
          }
  ...
  _callWithInputFile(method, inputFile, type, params) {
    ...
    return file
      ...
      .then(prepared => {
        ...
        return this._callWithReturnType(method, prepared.params, Message, prepared.multipart);
      })
      .then(r => {
        sentCallback();
   ...
   */
  getUpdates(options) {
    return this.call('getUpdates', options).then(r => r.result.map(u => Update.deserialize(u)));
  }
  ...
  sendMessage(chatId, text, options) {
    const params = {
      ...
      disable_web_page_preview: options && options.disable_web_page_preview ? options.disable_web_page_preview : true
    };

    if (text.length > 4096) {
      this.sendMessage(chatId, text.slice(0, 4096), options).then(() =>
  ...
  sendPhoto(chatId, photo, options) {
    ...
    return this._callWithInputFile('sendPhoto', photo, 'photo', Object.assign({ chat_id: chatId }, options));
  }
  ...
  sendAudio(chatId, audio, options) {
    return this._callWithInputFile('sendAudio', audio, 'audio', Object.assign({ chat_id: chatId }, options));
  }
  ...
  sendDocument(chatId, document, options) {
    return this._callWithInputFile('sendDocument', document, 'document', Object.assign({ chat_id: chatId }, options));
  }
  ...
  sendSticker(chatId, sticker, options) {
    return this._callWithInputFile('sendSticker', sticker, 'sticker', Object.assign({ chat_id: chatId }, options));
  }
  ...
  sendVideo(chatId, video, options) {
    return this._callWithInputFile('sendVideo', video, 'video', Object.assign({ chat_id: chatId }, options));
  }
  ...
  sendVoice(chatId, voice, options) {
    return this._callWithInputFile('sendVoice', voice, 'voice', Object.assign({ chat_id: chatId }, options));
  }
  ...
  kickChatMember(chatId, userId) {
    ...
    return this.call('kickChatMember', params).then(r => r.result);
  }
   ...
   */
  leaveChat(chatId) {
    return this.call('leaveChat', { chat_id: chatId }).then(r => r.result);
  }
  ...
  unbanChatMember(chatId, userId) {
    ...
    return this.call('unbanChatMember', params).then(r => r.result);
  }
  ...
  getChatAdministrators(chatId) {
    return this.call('getChatAdministrators', { chat_id: chatId }).then(r =>
      r.result.map(m => ChatMember.deserialize(m))
    );
  }
  ...
  getChatMembersCount(chatId) {
    return this.call('getChatMembersCount', { chat_id: chatId }).then(r => r.result);
  }
  ...
  answerCallbackQuery(callbackQueryId, options) {
    ...
    return this.call('answerCallbackQuery', Object.assign(params, options)).then(r => r.result);
  }
  ...
  editMessageText(text, options) {
    ...
    return this.call('editMessageText', Object.assign(params, options)).then(r =>
      typeof r.result === 'boolean' ? r.require : Message.deserialize(r.result)
    );
  }
  ...
  editMessageMedia(options) {
    const media = JSON.stringify(new InputMediaPhoto('photo', options.image, options.caption, 'html'));

    return this.call('editMessageMedia', { media, ...options }).then(r =>
      typeof r.result === 'boolean' ? r.require : Message.deserialize(r.result)
    );
  }
  ...
  editMessageCaption(options) {
    return this.call('editMessageCaption', options).then(r =>
      typeof r.result === 'boolean' ? r.require : Message.deserialize(r.result)
    );
  }
  ...
  editMessageReplyMarkup(options) {
    return this.call('editMessageReplyMarkup', options).then(r =>
      typeof r.result === 'boolean' ? r.require : Message.deserialize(r.result)
    );
  }
  ...
  deleteMessage(options) {
    return this.call('deleteMessage', options).then(r =>
      typeof r.result === 'boolean' ? r.require : Message.deserialize(r.result)
    );
  }
  ...
  answerInlineQuery(inlineQueryId, results, options) {
    ...
    return this.call('answerInlineQuery', Object.assign(params, options)).then(r => r.result);
  }
  ...
  setGameScore(userId, score, options) {
    ...
    return this.call('setGameScore', Object.assign(params, options)).then(r =>
      typeof r.result === 'boolean' ? r.require : Message.deserialize(r.result)
    );
  }

  getGameHighScores(userId, options) {
    return this.call('getGameHighScores', Object.assign({ user_id: userId }, options)).then(r =>
      r.result.map(m => ChatMember.deserialize(m))
    );
  }
   ...
   * @returns {Promise<Message>}
   */
  sendInvoice(chatId, options, payload) {
    const params = {
      chat_id: chatId,
      payload: payload,
      provider_token: this._payments.token
    };

    return this._callWithReturnType('sendInvoice', Object.assign(params, options), Message);
  }
   ...
   * @returns {Promise<boolean>}
   */
  answerPreCheckoutQuery(preCheckoutQueryId, options) {
    const params = {
      pre_checkout_query_id: preCheckoutQueryId
    };

    return this.call('answerPreCheckoutQuery', Object.assign(params, options)).then(r => r.result);
  }
}
