...
/**
 * Upon receiving a message with this object, Telegram services will hide the current custom keyboard and display the default letter-keyboard. By default, custom keyboards are displayed until a new keyboard is sent by a bot. An exception is made for one-time keyboards that are hidden immediately after the user presses a button (see ReplyKeyboardMarkup).
 */
...
class ReplyKeyboardHide {
  ...
  /**
   * Requests services to hide the custom keyboard
   * @returns {boolean}
   */
  get hideKeyboard() {
