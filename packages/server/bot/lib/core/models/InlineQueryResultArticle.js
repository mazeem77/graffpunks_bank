...
class InlineQueryResultArticle extends InlineQueryResult {
  ...
  static deserialize(raw) {
    return new InlineQueryResultArticle(
      ...
      raw['id'],
      raw['title'],
      raw['input_message_content']
        ? InputMessageContent.deserialize(raw['input_message_content'])
        : null,
      raw['reply_markup']
        ? InlineKeyboardMarkup.deserialize(raw['reply_markup'])
        : null,
  ...
  serialize() {
    return {
      ...
      input_message_content: this.inputMessageContent
        ? this.inputMessageContent.serialize()
        : undefined,
